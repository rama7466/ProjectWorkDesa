...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark p-2">
	  <div class="container-fluid">
	    <a class="navbar-brand d-flex align-items-center" href="#">
	    	<img src="assets/img/wikrama.png" width="30" height="24">
			...
			<div class="container header-box mt-3">
				<div class="row">
					<div class="col-md-12 text-center">
						<img src="assets/img/wikrama.png" class="img-fluid">
						<h3 class="mt-2">SMK WIKRAMA BOGOR</h3>
						<p>"Senyum,Sapa dan Sejahtera"</p>
					</div>
				</div>
			</div>
		</div>
	...
	<footer id="footer" class="mt-5 p-3 bg-dark">
		<div class="container text-center">
			<p class="text-white">&copy;&nbsp; Copyright By Rama Ramdhani</p>
		</div>
	</footer>
